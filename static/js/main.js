...
(function () {
    ...
    $(".quote-slider").bxSlider({mode: "horizontal", controls: false, adaptiveHeight: true});
    $(".img-slider").bxSlider({
                                  mode: "fade",
                                  pager: true,
                                  controls: true,
    ...
    $(".promo-control").click(function () {
        ...
        if ($(".footer-promo").is(":visible")) {
            $("html, body").animate({scrollTop: $(".footer-promo").offset().top}, 500)
        }
    });
    $(function () {
        $("#contactform").submit(function () {
            ...
            $("#message").slideUp(300, function () {
                $("#message").hide();
                $("#submit").after('<img src="images/loader.gif" class="loader">')
    ...
    $(function () {
        $(".scrollto").bind("click.scrollto", function (e) {
            ...
            var t = this.hash, n = $(t);
            $("html, body").stop()
                .animate({scrollTop: n.offset().top - 0}, 900, "swing", function () {
